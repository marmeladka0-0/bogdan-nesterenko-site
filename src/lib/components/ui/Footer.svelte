<script>
    ...
    const links = [
		{ href: 'https://youtube.com/@bogdannesterenko7139', icon: 'mdi:youtube', label: 'YouTube'},
        { href: 'https://www.instagram.com/bogdannesterenko74', icon: 'mdi:instagram', label: 'Instagram'},
        { href: 'https://www.linkedin.com/in/bogdan-nesterenko-29774975/', icon: 'mdi:linkedin', label: 'LinkedIn'},
        ...
        { href: 'https://open.spotify.com/artist/4rbrZcsGjag5jTFXqqNAvG?si=F5a48sF7QgCF-dWPdnqmDg', icon: 'mdi:spotify', label: 'Spotify'}
    ];

</script>

<footer class = "flex w-full justify-center bg-base-200 py-4 mt-8 max-w-6xl">
